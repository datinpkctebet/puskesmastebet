...
<section class="instrument-section">
  <x-partial.title
    title='Puskesmas Kelurahan Kebon Baru'
    ...
    <div class="container">
      ...
      <div class="instrument-view">
        <div class="col-md-6 ins-image">
          <img src="{{ URL('images/bonbar.jpg') }}" title="instrument" alt="" />
        </div>
        ...
        <div class="col-md-6 ins-details">
          ...
          <div class="span span1">
            ...
            <p style="color:black;" class="right">: drg. Agriaty Ritha</p>
            <div class="clearfix"></div>
          </div>

          <div class="span span2">
            <p class="left">Tahun didirikan</p>
            <p style="color:black;" class="right">: 1975</p>
            <div class="clearfix"></div>
          </div>
          ...
          <div class="span span4">
            ...
            <p style="color:black;" class="right">: Jl. Asem Baris IX No.1 RT.009 RW.005</p>
            <div class="clearfix"></div>
          </div>
        </div>
