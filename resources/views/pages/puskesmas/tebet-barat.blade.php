...
<section class="instrument-section">
  <x-partial.title
    title='Puskesmas Kelurahan Tebet Barat'
    ...
    <div class="container">
      ...
      <div class="instrument-view">
        <div class="col-md-6 ins-image">
          <img src="{{ URL('images/tebar.jpg') }}" title="instrument" alt="" />
        </div>
        ...
        <div class="col-md-6 ins-details">
          ...
          <div class="span span1">
            ...
            <p style="color:black;" class="right">: dr. Lindawati, MKM</p>
            <div class="clearfix"></div>
          </div>

          <div class="span span2">
            <p class="left">Tahun didirikan</p>
            <p style="color:black;" class="right">: 1962</p>
            <div class="clearfix"></div>
          </div>
          ...
          <div class="span span4">
            ...
            <p style="color:black;" class="right">: Jl.Tebet Barat IX/64, Kel.Tebet Barat</p>
            <div class="clearfix"></div>
          </div>
        </div>
