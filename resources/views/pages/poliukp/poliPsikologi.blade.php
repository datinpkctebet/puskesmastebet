...
<section class="test-menu">
  <x-partial.title
    title="Unit Pelayanan Konseling / Psikologi"
    description="" />

  <div class="test-desc">
    <div class="container">
      {{-- <h3>Test Description</h3> --}}
      <p><h1 style=font-family:arial align="justify"><font size="4">Pelayanan konseling dilakukan oleh psikologi klinis yang sudah terlatih dalam penanganan pasien-pasien yang membutuhkan konsultasi psikologi.
        Menangani konseling adiksi, kesulitan belajar, gangguan perilaku, gangguan jiwa dan gangguan psikologi lainnya.        
        </h1></p>
{{--         
      <table>
        <tr>
