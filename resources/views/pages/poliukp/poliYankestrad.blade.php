...
<section class="test-menu">
  <x-partial.title
    title="Unit Pelayanan Yankestrad"
    description="" />

  <div class="test-desc">
    <div class="container">
      {{-- <h3>Test Description</h3> --}}
      <p><h1 style=font-family:arial align="justify"><font size="4">Pelayanan kesehatan traditional yang dilakukan adalah layanan accupresure bagi yang membutuhkan.
        Pelayanan dilakukan oleh tenaga paramedis yang sudah terlatih dalam bidan accupresure.
         </h1></p>
