...
<section class="test-menu">
  <x-partial.title
    title="Layanan 24 Jam / Tindakan"
    description="" />

  <div class="test-desc">
    <div class="container">
      {{-- <h3>Test Description</h3> --}}
      <p><h1 style=font-family:arial align="justify"><font size="4">Pelayanan dilakukan setiap hari Senin s/d Minggu selama 24 jam, 
        termasuk Hari libur dan Hari Besar. Dilayani oleh dokter – dokter  Umum dan perawat yang sudah terlatih. 
        Melayani konsultasi kesehatan, pemeriksaan kesehatan, pengobatan dan tindakan diluar jam kerja ,penanganan kasus-kasus emergensi 
        dan stabilisasi sebelum dirujuk ke FKTRL. </h1> </p>
{{-- 
      <table>
        <tr>
          <th>Test</th>
