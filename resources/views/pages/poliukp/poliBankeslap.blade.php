...
<section class="test-menu">
  <x-partial.title
    title="Dukkeslap / Bankeslap"
    description="" />

  <div class="test-desc">
    <div class="container">
      {{-- <h3>Test Description</h3> --}}
      <p><h1 style=font-family:arial align="justify"><font size="4">Pelayanan yang dilakukan sebagai upaya Mendekatkan pelayanan kepada masyarakat yang mengalami musibah bencana, bantuan kesehatan lapangan dan bantuan kepada masyarakat yang membutuhkan pertolongan sebelum dibawa ke RS. Pelayanan ini bersifat situasional sesuai permintaan dan kejadian
        </h1></p>
