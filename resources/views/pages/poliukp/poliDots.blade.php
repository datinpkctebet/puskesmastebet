...
<section class="test-menu">
  <x-partial.title
    title="Unit Pelayanan DOTS"
    description="" />

  <div class="test-desc">
    <div class="container">
      {{-- <h3>Test Description</h3> --}}
      <p><h1 style=font-family:arial align="justify"><font size="4">Pelayanan DOTS melayani pasien TB  yang telah didiagnosa Tuberculosa (TB) dengan Pelayanan oleh dokter – dokter  umum dan perawat yang sudah terlatih dibidang penyakit TB. Melayani konsultasi kesehatan, pemeriksaan kesehatan, pengobatan pasien TB, melanjutkan pengobatan pasien TB MDR yang sudah stabil, serta rujukan terkait penyakit TB.
        Selain melayani pengobatan TB di layanan DOTS juga melayani pengobatan kusta.
        Pelayanan oleh dokter dan perawat yang sudah terlatih dalam penanganan pasien TB dan Kusta.
        </h1></p>
